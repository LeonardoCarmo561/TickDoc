...
import { InternalUserData } from '@/@types/internal-users-services'
import { CreateInternalUserButton } from '../form-button'

export function InternalUsersTable(props: {
        ...
        <div className="flex flex-1 gap-1 items-center">
          ...
          <button
            onClick={() => {
              ...
              push(`internalusers?${currentQuery}`)
            }}
        ...
        <table className="w-full divide-y divide-zinc-500">
          <thead>
            <tr>
              ...
              <th align="center" className="py-3 pr-3">
                Status
              </th>
            </tr>
          </thead>
                ...
                <tr key={row.id}>
                  <td align="center" className="py-3">
                    <Tooltip title="detalhes" position="rigth">
                      <Link
                        href={`internalusers/details/${row.id}`}
                        tabIndex={-1}
                      >
